...
$pics = array("nopics.jpg", "nopics.jpg", "nopics.jpg", "nopics.jpg", "nopics.jpg", "nopics.jpg", "nopics.jpg", "nopics.jpg", "nopics.jpg");
...
<div class="date">7</div><div class="month">september</div><div class="year">2017</div>
</h1>
</div>
</center>
...
$name = $_GET["birthday"];
 ...
 $index = array_search($name ,$birthday); 
...
<img src="<?php echo $pics[$index];?>" width="250px" height="250px">

<p> BIRTHDAY : <?php echo $date[$index]." ".$month[$index]." ".$years[$index];?> </p>
